# Lessons (legacy, superseded by the course)

> **These five lessons are superseded by the full course in
> [`../course/`](../course/README.md)** (6 modules, 28 lessons, APA-7 citations,
