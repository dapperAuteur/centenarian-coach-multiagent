...
happen to routing reproducibility if you set `temperature: 0.8` on the supervisor, and why the eval suite's routing-accuracy assertion would start flickering. Module
