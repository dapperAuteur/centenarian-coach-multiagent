...
// The email-based admin/waitlist form. Extracted from page.tsx so the route can
// be a server component that conditionally renders the "Sign in with WitUS"
// button above this form (the button uses a server action; see page.tsx).
//
// Flow:
